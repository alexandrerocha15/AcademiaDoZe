...
public class AcessoColaboradorTests
{
    ...
    [InlineData(true)]
    [InlineData(false)]
    public void Deve_Falhar_Criacao_Quando_ColaboradorEhNulo(
        bool colaboradorNull)
    {
        var colaborador = colaboradorNull
            ? null
            : GetValidColaborador();
        ...
        if (colaboradorNull)
        {
            ...
            Assert.Contains(
                ...
                n => n.Mensagem == "COLABORADOR_INVALIDO");
        }
        else
        {
        ...
        int minute)
    {
        ...
        Assert.Contains(
            result.Notifications,
            n => n.Mensagem == "DATA_HORA_INTERVALO_INVALIDO");
    }
