...
public class MatriculaTests
{
        ...
        bool useDefault)
    {
        ...
        if (useDefault)
        {
            ...
            Assert.Contains(
                result.Notifications,
                n => n.Mensagem == "DATA_INICIO_OBRIGATORIO");
        }
        else
        {
            Assert.True(result.IsSuccess);
    ...
    public void Deve_Calcular_DataFim_Corretamente(
        ...
        bool expectFailure)
    {
        ...
        if (expectFailure)
        {
            ...
            Assert.Contains(
                result.Notifications,
                n => n.Mensagem == "MENOR_16_LAUDO_OBRIGATORIO");
        }
    }
        ...
        bool provideLaudo)
    {
        ...
        else
        {
            ...
            Assert.Contains(
                result.Notifications,
                n => n.Mensagem == "RESTRICOES_LAUDO_OBRIGATORIO");
        }
    }
    ...
    public void Deve_Normalizar_ObservacoesRestricoes_Quando_InputTemEspacosExtras(
        string input,
        string expected)
    {
        var aluno = GetValidAluno();
