...
public class NormalizacaoServiceTests
{
    ...
    public void Deve_TextoVazioOuNulo_RetornarEsperado(
        string? input,
        bool expected)
    {
    ...
    [InlineData("a\tb\nc", "a b c")]
    public void Deve_Normalizar_Espacos_Quando_LimparEspacosChamado(
        string? input,
        string expected)
    {
    ...
    [InlineData(" a b ", "ab")]
    public void Deve_Remover_Todos_Espacos_Quando_LimparTodosEspacosChamado(
        string? input,
        string expected)
    {
    ...
    public void Deve_Converter_Para_Maiusculo_Quando_ParaMaiusculoChamado(
        string? input,
        string expected)
    {
    ...
    public void Deve_Manter_Apenas_Digitos_Quando_LimparEDigitosChamado(
        string? input,
        string expected)
    {
