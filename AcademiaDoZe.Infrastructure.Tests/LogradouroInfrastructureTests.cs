...
public class LogradouroInfrastructureTests : TestBase
{
    ...
    public async Task Logradouro_Atualizar_Sucesso()
    {
        ...
        var resultado =
            await _repository.Atualizar(logradouroAtualizado);
    ...
    public async Task Logradouro_ObterPorCep_SucessoENulo()
    {
        ...
        var naoObtido =
            await _repository.ObterPorCep(cepInexistente);
    ...
    public async Task Logradouro_CepJaExiste_ValidacaoCorreta()
    {
        ...
        var existe =
            await _repository.CepJaExiste(logradouro.Cep);
        ...
        var existeInedito =
            await _repository.CepJaExiste(cepInedito);
