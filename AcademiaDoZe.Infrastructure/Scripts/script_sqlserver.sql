-- ============================================================
-- SCRIPT DE CRIAÇÃO DO BANCO DE DADOS: db_academia_do_ze
-- SQL Server
-- ============================================================
...
BEGIN
    CREATE TABLE tb_aluno (
        ...
        CONSTRAINT FK_tb_aluno_tb_logradouro
...
BEGIN
    CREATE TABLE tb_colaborador (
        ...
        CONSTRAINT FK_tb_colaborador_tb_logradouro
            FOREIGN KEY (logradouro_id)
            REFERENCES tb_logradouro(id_logradouro)
    );
...
BEGIN
    CREATE TABLE tb_acesso (
        ...
        data_hora DATETIME NOT NULL
            CONSTRAINT DF_tb_acesso_data_hora DEFAULT GETDATE(),
